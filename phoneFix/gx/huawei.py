...
def huawei():
	...
	wrong_arr = ['None']
	try:
		js1 = hhnetworm.getRes(url1,result='j',data={'json':'jQuery111308920180139684155_1508484428667','productId':4903,'_':1508484428671,'siteCode':'cn'})
		for aa in js1:

			js2 = hhnetworm.getRes(url2,result='j',data={'json':'jQuery111308920180139684155_1508484428667','productCode':aa['productCode'],'_':1508484428672,'siteCode':'cn'})
			for bb in js2:
