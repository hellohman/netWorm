...
this_data = parkcentral()

excel_1 = HhExcel()
excel_1.writer(r'C:\Users\HH\Desktop\将军澳中心.xlsx', [{'sheetName': '将军澳中心', 'fields': ['店名', '商铺号', '营业时间', '电话', '简介'], 'data': this_data}])
